...
{
    static public class SpinelMode
    {
        #region Private Data
        ...
        public static void UpdateGUI()
        {
            ...
            try
            {
                ...
                //if (!GuiManager.GenericSheet["SpellbookWindow"].IsVisible &&
                //    !GuiManager.GenericSheet["OptionsWindow"].IsVisible &&
                //    (GuiManager.ControlWithFocus == null || !GuiManager.ControlWithFocus.Name.Contains("PrivateMessage")))
