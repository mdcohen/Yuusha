...
namespace Yuusha.gui
{
    ...
    {
        /// <summary>
        /// The cells directly next to a player in the game world. Usually some form of advanced interaction.
        /// </summary>
        ...
        {
            if (Character.CurrentCharacter == null || !Client.InGame) return;
        ...
        {
            if (Character.CurrentCharacter == null || Character.CurrentCharacter.Cell == null || !Client.InGame) return;
        ...
        protected override void OnDoubleLeftClick()
        {
            ...
            try
            {
                ...
                else if (CellsTouchingMe.Contains(Name.Replace("Tile", "")) && GameHUD.Cells[int.Parse(Name.Replace("Tile", ""))] is Cell doorCell && doorCell.IsDoorWay())
                {
                    ...
                    IO.Send(doorCommand + " door " + Map.GetDirection(GameHUD.Cells[24], GameHUD.Cells[int.Parse(Name.Replace("Tile", ""))]));
                }
                else if (CellsTouchingMe.Contains(Name.Replace("Tile", "")) && GameHUD.Cells[int.Parse(Name.Replace("Tile", ""))].IsSearchable())
                {
        ...
        protected string GetMovementDirections()
        {
            try
            {
                if (Character.CurrentCharacter is null || Character.CurrentCharacter.Cell is null || !Client.InGame) return "";
            }
            catch
            {
                return "";
